export const HeroSection: React.FC = () => {
  return (
    <section className="relative flex-1">
      ...
      />
      <div className="absolute inset-0 -z-10 h-full w-full bg-gradient-to-r from-[#000B11] to-transparent object-cover" />
      ...
      <div className="flex h-full max-w-6xl flex-col justify-center gap-6 px-2 py-4 lg:mx-auto">
        ...
        <a
          className="w-fit rounded-lg border border-green-500 bg-green-500 px-6 py-2 font-medium text-gray-50 transition-all hover:brightness-110 focus:outline-none focus:brightness-110"
